...
class Registration(models.Model):
    ...
    parents_contact_number = models.CharField("Parent's Contact Number", max_lenght = 50)

    status = models.CharField("Status", max_lenght =11, default = "Approved")
    ...
    #   return reverse("registration_detail",
    #       args=[str(self.pk)])
